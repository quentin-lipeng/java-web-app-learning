...
public class TokenManager {
    ...
    //用户登录管理
    public static final SampleRealm realm =
            SpringContextUtil.getBean("sampleRealm", SampleRealm.class);

    //用户session管理
    public static final CustomSessionManager customSessionManager =
            SpringContextUtil.getBean("customSessionManager", CustomSessionManager.class);
    ...
    public static UUser login(UUser user, Boolean rememberMe) {
        ...
        logger.info("user password" + user.getPswd());
